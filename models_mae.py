...
# so a machine learning competition is not commercial use, right?
# ...right?
...
class MyMLP(nn.Module):
    ...
    def __init__(
        ...
        self.fc2 = linear_layer(hidden_features, hidden_features)
        self.act2 = act_layer()
        self.norm2 = norm_layer(hidden_features) if norm_layer is not None else nn.Identity()
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs, mask_ratio=0.75, x_orig=None):
        if x_orig is None: x_orig = imgs
